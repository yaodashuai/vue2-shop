<template>
  <div class="prodetail">
    ...
    <van-swipe :autoplay="3000" @change="onChange">
      <van-swipe-item v-for="image in images" :key="image.fild_id">
      ...
      <van-action-sheet v-model="showPannel" :title="mode === 'cart' ? '加入购物车' : '立刻购买'">
        <div class="product">
          ...
          <div class="showbtn" v-if="detail.stock_total > 0 ">
            <div class="btn" v-if="mode === 'cart' " @click="add">加入购物车</div>
...
export default {
  ...
  methods: {
    async getProDetail () {
      ...
      this.images = detail.detail.goods_images
    },
